...
//Change based on the setting
$api_url = "http:/database_rss_project/rest_api/test_api.php?action=fetch_all";
			...
			if ($row->current_status=='ENABLED') {
				...
				$output .= '
					<tr>
						...
						<td>
							<button type="button" name="edit" class="btn btn-warning btn-xs edit" id="'.$row->id.'">
								Edit
							</button>
						</td>
						<td>
						...
						<td>
							<button type="button" name="refresh" class="btn btn-success btn-xs"  id="'.$row->id.'">
								Refresh
							</button>
						<td>
